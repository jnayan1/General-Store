              ...
              <table class = 'table'>
                <thead>
                  <tr>
                    ...
                    <th><b>Commodities Supplied</b></th>
                    <td></td>
                  </tr>
                  <tr></tr>
                </thead>
                <?php
                  require_once("../controller/view_mills.php"); 
                ?>
              </table>
          <div class='col-md-5'></div>
          <div class='col-md-2'><a href="mill.php"><button class="btn btn-lg btn-primary btn-block">Add New Mill</button></a></div>
          <div class='col-md-5'></div>
          </div>
        </div>
    </div>
    <div class="container" id='form' style='display:none;'>
     <!--v class="starter-template">-->
<div class = "container">
        <div class="row">
       ...
       <div class='col-md-4'></div>
        ...
        <h2 class="page-header">Enter New Details</h2><br />
          <form id='details' class="col-md-12" role="form" action='../controller/edit_mills.php' method='post'>
            ...
            <div class="form-group">
                <div class="input-group">
            <input class="form-control" name='name' placeholder='Mill Name' required autofocus="" type='text'>
            <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
            </div>
            </div>
...
<div class="form-group">
                <div class="input-group">
            <input class="form-control" name='commodity' placeholder='Commodities Supplied' required autofocus="" type='text'>
             <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
            </div>
            </div>
