              ...
              <table class = 'table'>
                <thead>
                  <tr>
                    ...
                    <th><b>Threshold Quantity</b></th>
                    <th><b>Price/kilo</b></th>
                  </tr>
                  <tr></tr>
                </thead>
                <?php
                  require_once("../controller/current_stock.php"); 
                ?>
              </table>
          <div class='col-md-5'></div>
          <div class='col-md-2'><a href="Mill_order.php"><button class="btn btn-lg btn-primary btn-block">Order Commodity</button></a></div>
          <div class='col-md-5'></div>
          </div>
        </div>
    </div>
