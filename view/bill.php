...
<!--    <title>Registration form Template | PrepBootstrap</title>-->
  ...
  <body>
    ...
    <div class="container">
		...
		<div class="container">
		    <div class="row">
		        <form role="form" action="../controller/addbill.php" method='post'>
		            <div class="col-lg-6">
		                <!--<div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>-->
		                <div class="form-group">
		                    <div class="input-group">
		                        <input type="text" class="form-control" placeholder="Name of the buyer" name="name" required>
		    			...
		    			<div class="form-group">
		                	<div class="input-group">
				                <select class='form-control' name="paid" placeholder="Mode of payment" required>
				                	<option>Cash</option>
				                    <option>Credit Card</option>
				                    <option>Cheque</option>
				                    <option>Will be paid later</option>
				                </select>
			                  	<span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
