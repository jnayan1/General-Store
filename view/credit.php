  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <div class="page-header">
          <h1>Add Credits/Debits </h1>
      </div>

<!-- Registration form - START -->
        <div class="container">
            <div class="row">
                <form role="form" method ='post' action='../controller/addcredit.php'>
                    <div class="col-lg-6">
                        <!--<div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>-->
                        <div class="form-group">
          <!--                  <label for="InputName">Name</label>-->
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Name of the person" name="name" required>
