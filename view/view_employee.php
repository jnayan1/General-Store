              ...
              <table class = 'table'>
                <thead>
                  <tr>
                    ...
                    <th><b>Salary</b></th>
                    <th><b>Area of Work</b></th>
                    <td></td>
                  </tr>
                  <tr></tr>
                </thead>
                <?php
                  require_once("../controller/view_employee.php"); 
                ?>
              </table>
          <div class='col-md-5'></div>
          <div class='col-md-2'><a href="employee.php"><button class="btn btn-lg btn-primary btn-block">Add New Employee</button></a></div>
          <div class='col-md-5'></div>
          </div>
        </div>
    </div>
      ...
      <div class = "container">
        ...
        <!--<div id='form' style='display:none;'>-->
          <h2 class="page-header">Enter New Details</h2><br />
            ...
            <form id='details' class='col-md-12' role="form" action='../controller/edit_employee.php' method='post'>
