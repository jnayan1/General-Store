...
<!--    <title>Registration form Template | PrepBootstrap</title>-->
  ...
  <body>
        ...
        <div class="container">
            <div class="row">
              ...
              <table class = 'table'>
                ...
                <?php
                  require_once("../controller/view_credit.php"); 
                ?>
              </table>
          <div class='col-md-5'></div>
          <div class='col-md-2'><a href="../view/credit.php"><button class="btn btn-lg btn-primary btn-block">Add New Udhaar</button></a></div>
          <div class='col-md-5'></div>
          </div>
        </div>
    </div>
    ...
    function del(url){
      //alert('abc');
      location.href = '../controller/delete_udhaar.php?'+url;
    }
    </script>
  </body>
</html>