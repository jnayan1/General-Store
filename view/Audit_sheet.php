  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Audit Sheet - Add Entry</h1>
        </div>

        <!-- Registration form - START -->
        <div class="container">
            <div class="row">
                <form role="form" action = "../controller/audit_sheet.php" method='post'>
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="number" class="form-control"  name="retail" placeholder="Retail Amounts(in Rs)" required>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <input type="number" class="form-control"  name="purchase" placeholder="Purchase Amounts(in Rs)" required>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           <!-- <label for="InputName">Contact</label>-->
                            <div class="input-group">
                                <input type="number" class="form-control"  name="salary" placeholder="Salary Given(in Rs)" required>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
