  ...
  <body>
   ...
   <div class="container">
    ...
    <div class="container">
		...
		<div class="container">
		    <div class="row">
		        <form role="form" class='col-md-8' action = "../controller/retail_order.php" method='post'>
		            <div class="col-lg-6">
		                <!--<div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>-->
		                <div class="form-group">
		                    <div class="input-group">
		                    	<select type="text" class="form-control" placeholder="Retailer Number" name="retailer" required>
	                              <?php
	                                 require '../controller/config_sql.php';
	                                 $sql = mysql_query("SELECT * FROM Retailers");
